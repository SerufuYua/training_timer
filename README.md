...
Or use [Lazarus](https://www.lazarus-ide.org/). Open in Lazarus `TrainingTimer.lpi` file and compile / run from Lazarus. Make sure to first register [PlaySoundPackage Lazarus packages]
